...
ALTER TABLE PUBLIC.ANSWERBOT_DYNDNS ADD CONSTRAINT ANSWERBOT_DYNDNS_SIP_FK FOREIGN KEY (ABID) REFERENCES ANSWERBOT_SIP(ID) ON DELETE CASCADE ON UPDATE RESTRICT;
...
CREATE TABLE ANSWERBOT_SIP (
	...
	LAST_REGISTER BIGINT DEFAULT 0 NOT NULL,
	REGISTER_ERROR CHARACTER VARYING(512),
	
	CALLS_ACCEPTED INTEGER DEFAULT 0 NOT NULL,
	
	CONSTRAINT ANSWERBOT_SIP_PK PRIMARY KEY (USERID)
);
CREATE UNIQUE INDEX ANSWERBOT_SIP_USERNAME ON ANSWERBOT_SIP (USERNAME);
