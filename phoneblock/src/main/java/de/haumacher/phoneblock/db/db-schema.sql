...
-- PUBLIC.ANSWERBOT definition

-- Drop table

-- DROP TABLE ANSWERBOT;
...
CREATE TABLE ANSWERBOT_DYNDNS (
	...
	IP4 CHARACTER VARYING(64),
	IP6 CHARACTER VARYING(64),
	
	CONSTRAINT ANSWERBOT_DYNDNS_PK PRIMARY KEY (USERID)
);
...
CREATE TABLE ANSWERBOT_SIP (
	...
	SIP_REGISTRAR CHARACTER VARYING(64) DEFAULT 'fritz.box' NOT NULL,
	SIP_DOMAIN CHARACTER VARYING(64) DEFAULT 'fritz.box' NOT NULL,
	SIP_USER CHARACTER VARYING(64) NOT NULL,
	SIP_PASSWD CHARACTER VARYING(64) NOT NULL,

	REGISTERED BOOLEAN DEFAULT FALSE NOT NULL,
	LAST_REGISTER BIGINT,
...
CREATE UNIQUE INDEX ANSWERBOT_SIP_USER ON ANSWERBOT_SIP (SIP_USER);
