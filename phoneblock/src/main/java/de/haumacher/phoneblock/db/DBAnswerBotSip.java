...
public class DBAnswerBotSip extends AnswerBotSip {
	 ...
	 */
	public DBAnswerBotSip(long id, long userId, long updated, long lastSuccess, boolean registered, String registerMessage, String host, String ip4, String ip6, String registrar, String realm, String userName, String passwd) {
		setId(id);
		setUserId(userId);
		setUpdated(updated);
