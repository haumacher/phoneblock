 ...
 */
class UpdateMessage_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements UpdateMessage {
	 ...
	 *
	 * @see UpdateMessage#create()
	 */
	protected UpdateMessage_Impl() {
		super();
	}
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return UpdateMessage.super.get(field);
		}
	}
	...
	public void set(String field, Object value) {
		switch (field) {
			...
			case TYPE__PROP: internalSetType((Type) value); break;
		}
	}
	...
	/** Helper for creating an object of type {@link UpdateMessage} from a polymorphic composition. */
	public static UpdateMessage readUpdateMessage_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		de.haumacher.phoneblock.index.google.UpdateMessage_Impl result = new UpdateMessage_Impl();
