	...
	<div class="content">
		...
		<div class="columns">
			<div class="column is-two-fifths">
	  			<img class="image appscreen" alt="Berechtigungen" src="<%=request.getContextPath() %>/assets/img/peoplesync/05-people-sync-accept.png"/>
	  		</div>
			<div class="column is-two-fifths">
	  			<img class="image appscreen" alt="Sync-Intervalle" src="<%=request.getContextPath() %>/assets/img/peoplesync/06-people-sync-sync.png"/>
	  		</div>
		</div>
